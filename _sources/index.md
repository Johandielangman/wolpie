...
- [`play_sound`](play-sound): A function for playing sound files.
- [`ding`](with-ding): A context manager for playing a "ding" sound when a block of code finishes executing.
